...
export function googleOAuth2Routes (
    ...
    app.get('/login/callback', async function (request: FastifyRequest, reply: FastifyReply) {

        console.log("trying callback service")
        ...
        reply.redirect("https://localhost:3003/?access_token=" + token.access_token);
    });
